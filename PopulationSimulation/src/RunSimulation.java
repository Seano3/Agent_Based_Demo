...
public class RunSimulation{
    ...
    public static void main(String[] args) throws Exception {
        ...
        sim.addAgent(new Agent(2, 20, 550, 300, -5, 0));
        sim.addAgent(new Agent(3, 20, 100, 300, 10, 0));


        sim.addAgent(new Agent(4, 20, 300, 300, 0, 5));
        sim.addAgent(new Agent(5, 20, 300, 100, 0, -5));

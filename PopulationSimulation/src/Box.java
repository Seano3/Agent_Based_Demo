...
public class Box extends Obstacle {
     ...
     * @param Force - Anti-collision force exerted by the box on Agents. Not implemented
     */
     ...
     * @param width - The width of the box
     * @param height - The height of the box
     * @param xForce - Horizontal Anti-collision force exerted by the box on Agents. Not implemented
     * @param yForce - Vertical Anti-collision force exerted by the box on Agents. Not implemented
     */
    ...
    /**
     * <p> Checks if the x value of an agent is within the width of a box for top/bottom collision checking </p>
    ...
    /**
     * <p> Checks if the y value of an agent is within the height of a box for left/right collision checking </p>
    ...
    /**
     * <p> Checks if an agent has collided with the box in a given frame, and adjusts its velocity if it has </p>
    ...
    /**
     * <p> Draws the obstacle for a given component </p>
